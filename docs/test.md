...
- ✅ 强制: 使用 `rust_decimal::Decimal` (推荐) 或 `i64` (以最小单位存储，如分/厘)
- ✅ 强制: 数据库中对应类型为 `DECIMAL` 或 `BIGINT`
...
## 13. AI 辅助生成代码的"红线" (Red Lines for AI)
...
## 14. 提交前检查清单 (Pre-Commit Checklist)
