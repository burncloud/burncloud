...
配套文档:[`components.md`](./components.md) · [`pages.md`](./pages.md) · [`tokens.md`](./tokens.md) · [README.md](./README.md)
...
- **样式栈**:Tailwind CSS(布局工具类) + `styles/*.css`(设计系统 / 组件皮肤,由 `styles/mod.rs` 拼接进 `AppStyles`)
