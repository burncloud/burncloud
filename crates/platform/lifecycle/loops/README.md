...
| Layer | Location |
|-------|----------|
| Loop runner + gates | `crates/platform/lifecycle/loops/src/` |
| Acceptance criteria | `crates/platform/lifecycle/loops/acceptance/*.md` |
| E2E browser tests | `crates/interfaces/tests/tests/e2e/` |
