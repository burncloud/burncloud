...
完整验收（门禁与 `review.json` 格式）：`crates/platform/lifecycle/loops/acceptance/aesthetic-optimize-acceptance.md`（J0–J7）  
...
```bash
cd crates/interfaces/client && cargo check -p burncloud-client-shared
