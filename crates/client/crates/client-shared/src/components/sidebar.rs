    ...
    rsx! {
        div { class: "flex flex-col h-full gap-6 select-none",
            ...
            div { class: "flex flex-col gap-1",
                div { class: "px-3 text-[10px] font-bold text-base-content/40 uppercase tracking-widest mb-1", "智能中心" }
            ...
            // Section 2: Network
            div { class: "flex flex-col gap-1",
                div { class: "px-3 text-[10px] font-bold text-base-content/40 uppercase tracking-widest mb-1 mt-2", "网络设施" }
