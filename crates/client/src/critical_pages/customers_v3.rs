        ...
        div { class: "page",
            ...
            div { class: "metrics",
                ...
                div { class: "card metric card-hover",
                    div { class: "metric-copy",
                        ...
                        span { class: "metric-value", "{budget_alerts} Critical" }
                    }
                                        ...
                                        tr {
                                            ...
                                            td {
                                                div { class: "two-line customer-cost",
                                                    span { class: if ratio >= 0.9 { "strong danger" } else { "strong" },
            ...
            Drawer {
                ...
                div { class: "stack-lg",
                        ...
                        div { class: "card card-pad stack",
                            ...
                            div { class: "grid-2",
                                div {
                                    ...
                                    div { class: "small strong mono", "{tenant.requests} requests" }
                                }
                                div {
                                    span { class: "tiny subtle", "Current Month Spend" }
                                    div { class: "small strong mono", "${tenant.spend}" }
                                }
                            }
                        }
                    }
                    ...
                    div { class: "card card-pad stack",
                        span { class: "section-label", "Current / Pending Values" }
                        div { class: "small muted", "Name: {form_name}" }
                        div { class: "small muted", "Environment: {form_env}" }
                        div { class: "small muted", "Route: {form_route}" }
                        div { class: "small muted", "Rate limit: {form_rps} RPS" }
                        div { class: "small muted", "Monthly budget: ${form_budget}" }
                    }
                    ...
                    div { class: "field",
                        ...
                        input {
                            class: "input",
                            placeholder: "Enter a new tenant name or leave unchanged when editing",
                            oninput: move |evt| {
                                let value = evt.value();
                    ...
                    div { class: "grid-2",
                            ...
                            input {
                                ...
                                oninput: move |evt| {
                                    if let Ok(value) = evt.value().parse::<u32>() {
                                        form_rps.set(value.clamp(5, 500));
                                    }
                                },
                            }
                        }
                        div { class: "field",
                            ...
                            input {
                                ...
                                oninput: move |evt| {
                                    if let Ok(value) = evt.value().parse::<u32>() {
                                        form_budget.set(value.clamp(500, 50000));
                                    }
                                },
                            }
                        }
