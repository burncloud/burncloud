...
`crates/interfaces/server/src/api/` 下 7 个模块:auth, channel, group, log, monitor, token, user

## Sources

- `crates/interfaces/server/src/lib.rs` — 应用构建和启动
- `crates/interfaces/server/src/api/mod.rs` — 路由注册
